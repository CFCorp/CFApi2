...
// In real life scenario connection with regular database would be established (need to still learn how to use Neo4J)
// this is all test data and will not be pushed to the main
